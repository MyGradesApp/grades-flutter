...
PLEASE READ THIS TERMS OF USE CAREFULLY. These terms of use (“Agreement”) govern your use of our SwiftGrade software, products, and/or services (collectively, “Products”) and any information, content or appearing on or through the Products (collectively referred to as “Content”). By accessing or using the Products, you agree to the terms of this Agreement. If you have entered into another agreement with SwiftGrade concerning specific Products, then the terms of that agreement controls where it conflicts with these terms. SwiftGrade reserves the right, at any time, to modify, alter, update or remove portions of this Agreement. Please check this Agreement (as well as our privacy policy) from time to time as your continued use of the Product signifies your acceptance of any changed items.

1. YOUR LICENSE TO USE OUR PRODUCTS.

Subject to the terms and conditions of this Agreement and any agreement entered into by your institution relating to the Products, SwiftGrade grants you a limited, non-exclusive, non-transferable, license to access and use the Products. You shall not (a) copy the Product or any part, feature, function or user interface thereof (b) use the Product to store or transmit infringing, libelous, or otherwise unlawful or tortious material, or to store or transmit material in violation of third-party privacy rights (c) attempt to gain unauthorized access to the Product or its related systems or networks; and (d) reverse engineer the Product (to the extent such restriction is permitted by law).
...
This privacy policy covers the services accessed using SwiftGrade. SwiftGrade is an unofficial tool that provides students/parents timely access to student information including, but not limited to grades, discipline, and attendance. Swiftgrade does not store or alter student data in any way. Students can access SwiftGrade through their school or school district’s “District Portal” username and password.

This Privacy Policy describes SwiftGrade’s privacy practices in relation to information pulled from Student Information Systems through the software applications made available by us for use on or through mobile devices that link to this Privacy Policy (the “App”).

Information We Collect

“Personal Information” is information that identifies you as an individual or relates to an identifiable individual. No student information is collected by SwiftGrade. SwiftGrade keeps a student’s username and password in Local Storage Objects (LSOs) on their device to speed up future authentication, but no data ever leaves the device for servers accessible by SwiftGrade.

Tracking Technologies

Cookies, Beacons, and other Similar Technologies: Technologies such as cookies, beacons, tags and scripts are used by SwiftGrade. These technologies are used to make it easier for you to navigate our app and to store your password so you don’t have to enter it more than once.
...
We work with a third party service provider to help improve the quality of our service. This third party does not share your information with any other third parties. SwiftGrade uses the following third party service on the App:
...
Force Majeure. SwiftGrade shall not be liable for any delay or failure to perform any obligation hereunder due to causes beyond its control, including without limitation, war, riot, insurrection, civil commotion, terrorist activity, fire, industrial disputes of whatever nature, acts of nature, computer crimes, epidemics, acts or omissions of third party vendors or suppliers, equipment failures, public enemies of government, failure of telecommunications, system malfunctions, fire, or other casualty.

Waiver and Severability. Waiver by SwiftGrade of any default or breach by you of any provision contained in this Agreement does not constitute a waiver of any subsequent default or breach of the same or any other provision of this Agreement. If any part of this Agreement shall be held invalid, illegal, in conflict with any law, or otherwise unenforceable by a court of competent jurisdiction, the remainder of this Agreement will nevertheless remain in full force and effect. No Third Party Beneficiaries. The parties do not intend to confer any right or remedy on any third party.

No Third Party Beneficiaries. The parties do not intend to confer any right or remedy on any third party.

Entire Agreement. Except where you have entered into a specific agreement with SwiftGrade and/or for particular Products, this Agreement and our Privacy Policy contains the entire understanding are the entire and exclusive agreement between SwiftGrade and you regarding the subject matter of this Agreement and this Agreement supersedes all prior and contemporaneous negotiations and agreements, whether written or oral, between SwiftGrade and you with respect to the subject matter of this Agreement.

Assignment. You may not assign this Agreement to any third party without the prior written consent of the SwiftGrade. Any such purported assignment shall be null and void. Subject to the foregoing, this Agreement shall be binding upon and inure to the benefit of the parties and their respective successors, and permitted assigns, if any. SwiftGrade may assign its rights and obligations under this Agreement to a third party without your consent.
